...
def train_and_export_models(merged_data):
    ...
    merged_data['predicted_graduation'] = graduation_model.predict(X[['ipk_mahasiswa', 'nilai_rata_rata']])
    merged_data['predicted_achievement'] = achievement_model.predict(X)

    # Export predictions to Excel
    merged_data.to_excel('predicted_results.xlsx', index=False)
    print("Training completed, models exported, and predictions saved to Excel.")
